...
The *crm-core* plugin provide a few services with common functionality used by many {gr8crm} plugins.
...
.Customer.groovy
----
include::samples/TenantEntity.groovy[]
----
...
.Author.groovy
----
include::samples/AuditEntity.groovy[]
----
...
.MyEvent.groovy
----
include::samples/UuidEntity.groovy[]
----
